...
class AuditLogger:
    ...
    def log_event(self, event_type: str, actor: str, metadata: dict):
        ...
        current_hash = self.generate_hash(entry)
    ...
    def verify_chain(self):
        ...
        for index, line in enumerate(lines):
            ...
            recalculated_hash = self.generate_hash(verification_entry)

            if stored_hash != recalculated_hash:
                return {
                    "valid": False,
                    "error": f"Hash mismatch at log index {index}",
                }

            if entry["previous_hash"] != previous_hash:
                return {
                    "valid": False,
                    "error": f"Chain broken at log index {index}",
                }
